    ...
    <div className="my-20 relative">
      <div className="w-full flex flex-col md:flex-row items-center justify-center px-5 py-5">
        <div className="md:w-1/3  w-full flex justify-center items-center">
          <h1 className="md:text-5xl text-3xl capitalize font-bold ml-5 mb-20 md:mb-0 dark:text-gray-100">
            our happy <span className="text-lightText dark:text-btn2">clients</span>{" "}
          </h1>
        </div>
        ...
        <div className="w-2/3 ">
            <div className="w-full max-w-xl px-5 pt-5 pb-10 mx-auto text-gray-800 dark:text-gray-200 border border-btn2 dark:border-gray-700 rounded-lg shadow-lg dark:shadow-gray-900/50 dark:bg-gray-800 ">
            ...
            <div className="w-full mb-10">
              ...
              <p className="px-5 text-sm text-center text-gray-600 dark:text-gray-300 ">{text}</p>
            ...
            <div className="w-full">
              ...
              <p className="text-xs text-center text-gray-500 dark:text-gray-400 ">{username}</p>
            </div>
          </div>
          <div className="flex justify-center mt-5">
            <button
              className="mr-2 px-4 py-4 text-btn2 border-2 border-btn2 dark:border-gray-600 dark:text-gray-300 dark:hover:border-btn2 dark:hover:text-btn2 rounded-full"
              onClick={handlePrevClick}
            >
              <GrPrevious />
            </button>
            <button
              className="px-4 py-4 text-btn2 border-2 border-btn2 dark:border-gray-600 dark:text-gray-300 dark:hover:border-btn2 dark:hover:text-btn2 rounded-full"
